...
<div align="left"><h2 class="subTitle" style=" color:#34bdb9; width:1100px; height: 60px; margin-left: 490px;"><span>&lt;&nbsp;답변 자세히보기&nbsp;&gt;</span></h2>
<img src="<c:url value='/resources/images/밑줄쫙.png'/>" style="width: 260px; margin-left: 470px; margin-top: -80px;" ></div>
<div id="qna_ans_detail"  style="width: 1000px;">
<table class="table">
		<tr>
