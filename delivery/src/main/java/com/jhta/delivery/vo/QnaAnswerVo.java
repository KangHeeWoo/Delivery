...
public class QnaAnswerVo {
	...
	private int qna_num;
	public QnaAnswerVo() {}
	public QnaAnswerVo(int qna_ans_num, String qna_ans_title, String qna_ans_cont, Date qna_ans_regd, int qna_num) {
		super();
	...
	public String toString() {
		return "QnaAnswerVo [qna_ans_num=" + qna_ans_num + ", qna_ans_title=" + qna_ans_title + ", qna_ans_cont="
