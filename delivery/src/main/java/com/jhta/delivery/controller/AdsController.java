...
public class AdsController {
	...
	public String topAds(@RequestParam(value="pageNum",defaultValue="1")int pageNum,Model model,HttpSession session) {
	...
	public String mainAds(@RequestParam(value="pageNum",defaultValue="1")int pageNum,Model model,HttpSession session) {
		int sto_num=(Integer)session.getAttribute("sto_num");
